...
LEFT_EYE_HORIZ_POINTS = [33, 133]
LEFT_EYE_TOP_POINTS = [160, 158]
LEFT_EYE_BOTTOM_POINTS = [144, 153]

RIGHT_EYE_HORIZ_POINTS = [362, 263]
RIGHT_EYE_TOP_POINTS = [385, 387]
RIGHT_EYE_BOTTOM_POINTS = [380, 373]
...
MOUTH_TOP_POINTS = [82, 13, 312]
MOUTH_BOTTOM_POINTS = [87, 14, 317]
MOUTH_HORIZ_POINTS = [78, 308]
